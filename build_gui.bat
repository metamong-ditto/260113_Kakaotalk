...
python -m pip install pyautogui pyscreeze mouseinfo pygetwindow pyrect pywinauto pyperclip pillow pytesseract pyinstaller
...
python -m PyInstaller --clean --noconfirm kakao_openchat_gui.spec
